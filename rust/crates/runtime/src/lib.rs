//! Core runtime primitives for the `eidolon` CLI and supporting crates.
//!
...
pub mod syndicate_collection;
pub mod syndicate_memory;
pub mod syndicate_orchestrator;
pub mod task_packet;
...
pub use config::{
    ...
    EIDOLON_SETTINGS_SCHEMA_NAME,
};
pub use conversation::{
    auto_compaction_threshold_from_env, ApiClient, ApiRequest, AssistantEvent, AutoCompactionEvent,
    ConversationRuntime, IterationBudget, PromptCacheEvent, RuntimeError, StaticToolExecutor,
